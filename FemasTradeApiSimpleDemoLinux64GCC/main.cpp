/*******************************************************
* FemasTradeApiSimpleDemoLinux64GCC
* www.xfinapi.com
*******************************************************/
...
void MarketTest()
{
	...
	market = XFinApi_CreateMarketApi("XTA_L64/Api/Femas_v1.03/XFinApi.FemasTradeApi.so", &err);
...
void TradeTest()
{
	...
	trade = XFinApi_CreateTradeApi("XTA_L64/Api/Femas_v1.03/XFinApi.FemasTradeApi.so", &err);
