/*******************************************************
 * FemasTradeApiSimpleDemoJavaIdeaIC2018
 * www.xfinapi.com
 *******************************************************/
...
public class Main {
    ...
    static void PrintAccountInfo(XFinApi.TradeApi.Account acc) {
        System.out.println(String.format("  PreBalance=%g, Available=%g, CurrMargin=%g, Commission=%g, PositionProfit=%g, CloseProfit=%g, FrozenMargin=%g, FrozenCommission=%g, Withdraw=%g, Deposit=%g\n",
		acc.getPreBalance(), acc.getAvailable(), acc.getCurrMargin(), acc.getCommission(),
		acc.getPositionProfit(), acc.getCloseProfit(), acc.getFrozenMargin(), acc.getFrozenCommission(),
    ...
    static void MarketTest() {
        ...
        market = XFinApi.TradeApi.ITradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/Femas_v1.03/XFinApi.FemasTradeApi.dll", err);
    ...
    static void TradeTest() {
        ...
        trade = XFinApi.TradeApi.ITradeApi.XFinApi_CreateTradeApi("XTA_W32/Api/Femas_v1.03/XFinApi.FemasTradeApi.dll", err);
