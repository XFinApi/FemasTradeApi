######################################################
# FemasTradeApiSimpleDemoPythonPyCharmC2018
# www.xfinapi.com
######################################################
...
class MarketTest:
    ...
    def test(self):
        self.market = XFinApi_TradeApi.XFinApi_CreateMarketApi("XTA_W32/Api/Femas_v1.03/XFinApi.FemasTradeApi.dll")
...
class TradeEvent(XFinApi_TradeApi.TradeListener):
    ...
    def OnQueryAccount(self,accInfo):
         ...
         print(" PreBalance={}, Available={}, CurrMargin={}, Commission={}, PositionProfit={}, "
               "CloseProfit={}, FrozenMargin={}, FrozenCommission={}, Withdraw={}, Deposit={}".format(
             accInfo.PreBalance, accInfo.Available, accInfo.CurrMargin, accInfo.Commission, accInfo.PositionProfit,
             accInfo.CloseProfit, accInfo.FrozenMargin, accInfo.FrozenCommission, accInfo.Withdraw, accInfo.Deposit))
...
class TradeTest:
    ...
    def Test(self):
        ...
        self.trade = XFinApi_TradeApi.XFinApi_CreateTradeApi(
            "XTA_W32/Api/Femas_v1.03/XFinApi.FemasTradeApi.dll")
...
def main():
    ...
    if cfg.TradeAddress == "" or cfg.MarketAddress == "" or cfg.BrokerID == "" or cfg.UserName == "" or cfg.Password == "" :
